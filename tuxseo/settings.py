"""
Django settings for xeeaisto project.
...
from xeeaisto.logging_utils import scrubbing_callback
from xeeaisto.posthog_logs import (
    PostHogLogsEmitter,
...
MIDDLEWARE = [
    ...
    "xeeaisto.middleware.RequestLogContextMiddleware",
...
WSGI_APPLICATION = "xeeaisto.wsgi.application"
...
folder_name = f"xeeaisto-{ENVIRONMENT}"
...
DEFAULT_FROM_EMAIL = "Rasul from XeeAISto <rasul@tuxseo.com>"
SERVER_EMAIL = "XeeAISto Errors <error@tuxseo.com>"
...
if ENVIRONMENT == "prod":
    ...
    LOGGING["loggers"]["xeeaisto"]["level"] = env("DJANGO_LOG_LEVEL", default="INFO")
    LOGGING["loggers"]["xeeaisto"]["handlers"].append("json_console")
